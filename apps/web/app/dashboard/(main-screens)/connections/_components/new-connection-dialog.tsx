...
export function NewConnectionDialog({
  ...
  const handlePickerStateChange = (isActive: boolean) => {
    setIsPickerActive(isActive);
  };

  console.log(isPickerActive);
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        className="max-w-2xl bg-[#05060A]"
        style={{
          pointerEvents: isPickerActive ? 'none' : 'auto',
        }}
      >
        <DialogHeader>
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Click the button below to authorize access to your Google Sheets
                account.
              </p>
              <Button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Choose a spreadsheet from your Google Drive to sync expenses
                    to
                  </p>
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (id) {
                        setExistingSpreadsheetId(id);
                        setSelectedSpreadsheetName('Manual Entry');
                      }
                    }}
                    className="mt-2"
                  />
        ...
        {step === 'mapping' && spreadsheetInfo && (
          <div className="space-y-6">
            <div>
              <Label className="text-base font-medium">Select Worksheet</Label>
              <Select
